...
This document describes the architecture of the **Garry RAG Repo Harness** system, including build-time and runtime components.

## System Overview

**Garry RAG Repo Harness** is a static RAG (Retrieval-Augmented Generation) system that indexes GitHub repositories at build time and provides a searchable interface at runtime. The system operates in two distinct phases:
